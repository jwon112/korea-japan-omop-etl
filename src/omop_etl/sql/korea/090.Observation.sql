...
from (
    select
        TRY_CONVERT(varchar(4), hchk_year) as hchk_year,
        TRY_CONVERT(int, person_id) as person_id,
        TRY_CONVERT(varchar(50), ykiho_gubun_cd) as ykiho_gubun_cd,
...
CREATE CLUSTERED INDEX IX_GJ_VERTICAL_type_year_person
    ON @NHISNSC_database.GJ_VERTICAL (meas_type, hchk_year, person_id)
...
from (
    select
        TRY_CONVERT(varchar(4), STND_Y) as hchk_year,
        TRY_CONVERT(int, person_id) as person_id,
...
CREATE CLUSTERED INDEX IX_JK_VERTICAL_type_year_person
    ON @NHISNSC_database.JK_VERTICAL (jk_type, hchk_year, person_id)
    WITH (MAXDOP = 1, SORT_IN_TEMPDB = OFF);
GO
...
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_STAT_TYPE_RSPS_CD',	'36',	1,		903651,		44814721,	NULL,		NULL,		NULL);
...
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_STAT_TYPE_RSPS_CD',	'36',	3,		903657,		44814721,	NULL,		NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_TERM_RSPS_CD',		'37',	1,		40766364,		44814721,	NULL,		NULL,		2.5) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_TERM_RSPS_CD',		'37',	2,		40766364,		44814721,	NULL,		NULL,		7.5) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_TERM_RSPS_CD',		'37',	3,		40766364,		44814721,	NULL,		NULL,		15) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_TERM_RSPS_CD',		'37',	4,		40766364,		44814721,	NULL,		NULL,		25) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('SMK_TERM_RSPS_CD',		'37',	5,		40766364,		44814721,	NULL,		NULL,		30) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CUR_SMK_TERM_RSPS_CD',	'38',	0,		40766364,		44814721,	9448,		NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CUR_DSQTY_RSPS_CD',		'39',	0,		40766929,		44814721,	NULL,		NULL,		NULL) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('PAST_SMK_TERM_RSPS_CD',	'40',	0,		40766364,		44814721,	9448,		NULL,		NULL) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('PAST_DSQTY_RSPS_CD',	'41',	0,		40766930,		44814721,	NULL,		NULL,		NULL) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DSQTY_RSPS_CD',			'42',	1,		40766929,		44814721,	NULL,		NULL,		0.25) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DSQTY_RSPS_CD',			'42',	2,		40766929,		44814721,	NULL,		NULL,		0.75) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DSQTY_RSPS_CD',			'42',	3,		40766929,		44814721,	NULL,		NULL,		1.5) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DSQTY_RSPS_CD',			'42',	4,		40766929,		44814721,	NULL,		NULL,		2) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	1,		40771103,		44814721,	NULL,		45882527,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	2,		40771103,		44814721,	NULL,		45885249,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	3,		40771103,		44814721,	NULL,		45881653,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	4,		40771103,		44814721,	NULL,		45885248,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	5,		40771103,		44814721,	NULL,		45879676,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('TM1_DRKQTY_RSPS_CD',	'44',	1,		3037705,		44814721,	710235,	NULL,		3.5) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('TM1_DRKQTY_RSPS_CD',	'44',	2,		3037705,		44814721,	710235,	NULL,		7);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('TM1_DRKQTY_RSPS_CD',	'44',	3,		3037705,		44814721,	710235,	NULL,		10.5);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('TM1_DRKQTY_RSPS_CD',	'44',	4,		3037705,		44814721,	710235,	NULL,		14)	;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('EXERCI_FREQ_RSPS_CD',	'45',	1,		4036426,		44814721,	NULL,		45882527,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('EXERCI_FREQ_RSPS_CD',	'45',	2,		4036426,		44814721,	NULL,		45881653,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('EXERCI_FREQ_RSPS_CD',	'45',	3,		4036426,		44814721,	NULL,		45885248,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('EXERCI_FREQ_RSPS_CD',	'45',	4,		4036426,		44814721,	NULL,		45883166,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('EXERCI_FREQ_RSPS_CD',	'45',	5,		4036426,		44814721,	NULL,		45879676,	NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('MOV20_WEK_FREQ_ID',		'46',	0,		0,		44814721,	NULL,		NULL,		NULL) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('MOV30_WEK_FREQ_ID',		'47',	0,		0,		44814721,	NULL,		NULL,		NULL) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('WLK30_WEK_FREQ_ID',		'48',	0,		0,		44814721,	NULL,		NULL,		NULL) ;
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	0,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	1,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	2,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	3,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	4,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	5,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	6,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	7,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	8,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	9,		3004572,		44814721,	NULL,	NULL,		NULL);
insert into #observation_mapping (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('CTRB_PT_TYPE_CD',		'49',	10,		3004572,		44814721,	NULL,	NULL,		NULL);

-- Keep only active standard Observation concepts and standard Unit concepts.
-- Legacy project-specific concepts remain represented by the raw field/value.
UPDATE m
SET observation_concept_id = 0
FROM #observation_mapping m
LEFT JOIN @NHISNSC_database.CONCEPT c
  ON c.concept_id = m.observation_concept_id
WHERE ISNULL(m.observation_concept_id, 0) <> 0
  AND (
    c.concept_id IS NULL
    OR c.domain_id <> 'Observation'
    OR ISNULL(c.standard_concept, '') <> 'S'
    OR c.invalid_reason IS NOT NULL
  );

UPDATE m
SET observation_unit_concept_id = NULL
FROM #observation_mapping m
LEFT JOIN @NHISNSC_database.CONCEPT c
  ON c.concept_id = m.observation_unit_concept_id
WHERE m.observation_unit_concept_id IS NOT NULL
  AND (
    c.concept_id IS NULL
    OR c.domain_id <> 'Unit'
    OR ISNULL(c.standard_concept, '') <> 'S'
...
INSERT INTO @NHISNSC_database.OBSERVATION (observation_id, person_id, observation_concept_id, observation_date, observation_datetime, observation_type_concept_id, value_as_number, value_As_string, value_as_concept_id,
	...
	select	CONVERT(BIGINT, c.master_seq) * 100
			+ TRY_CONVERT(BIGINT, b.id_value) as observation_id,
			a.person_id as person_id,
			b.observation_concept_id as observation_concept_id,
			TRY_CONVERT(DATE, CONCAT(a.hchk_year, '0101'), 112) as observation_date,
			...
			a.meas_type as observation_source_value,
	...
	where (a.meas_value != '' and a.meas_type in ('HCHK_PMH_CD1', 'HCHK_PMH_CD2', 'HCHK_PMH_CD3','HCHK_APOP_PMH_YN', 'HCHK_HDISE_PMH_YN', 'HCHK_HPRTS_PMH_YN', 
		...
		or(a.meas_value != '' and a.meas_type in ('DRNK_HABIT_RSPS_CD', 'TM1_DRKQTY_RSPS_CD') and a.hchk_year in ('2002', '2003', '2004', '2005', '2006', '2007', '2008')))
			and c.source_table = 'GJT'
			and TRY_CONVERT(DATE, CONCAT(a.hchk_year, '0101'), 112) IS NOT NULL
...
INSERT INTO @NHISNSC_database.OBSERVATION (observation_id, person_id, observation_concept_id, observation_date, observation_datetime, observation_type_concept_id, value_as_number, value_As_string, value_as_concept_id,
	...
	from (select hchk_year, person_id, ykiho_gubun_cd, meas_type, meas_value
		...
		JOIN #observation_mapping b 
		on a.meas_type = b.meas_type
			and TRY_CONVERT(float, a.meas_value) IS NOT NULL
		JOIN @NHISNSC_database.SEQ_MASTER c
		on a.person_id = c.person_id
			and a.hchk_year = c.hchk_year
		JOIN @NHISNSC_database.VISIT_OCCURRENCE v
		on v.visit_occurrence_id = c.master_seq
			and v.person_id = c.person_id
	where (a.meas_value != '' and a.meas_type in ('CUR_SMK_TERM_RSPS_CD', 'CUR_DSQTY_RSPS_CD', 'PAST_SMK_TERM_RSPS_CD', 'PAST_DSQTY_RSPS_CD', 
																	'MOV20_WEK_FREQ_ID', 'MOV30_WEK_FREQ_ID', 'WLK30_WEK_FREQ_ID'))
			and c.source_table = 'GJT'
			and TRY_CONVERT(DATE, CONCAT(a.hchk_year, '0101'), 112) IS NOT NULL
OPTION (MAXDOP 2, RECOMPILE);
...
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	1,		40771103,		44814721,	NULL,		NULL,		0);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	2,		40771103,		44814721,	NULL,		NULL,		1);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	3,		40771103,		44814721,	NULL,		NULL,		2);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	4,		40771103,		44814721,	NULL,		NULL,		3);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	5,		40771103,		44814721,	NULL,		NULL,		4);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	6,		40771103,		44814721,	NULL,		NULL,		5);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	7,		40771103,		44814721,	NULL,		NULL,		6);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('DRNK_HABIT_RSPS_CD',	'43',	8,		40771103,		44814721,	NULL,		NULL,		7);
insert into #observation_mapping09 (meas_type, id_value, answer, observation_concept_id, observation_type_concept_id, observation_unit_concept_id, value_as_concept_id, value_as_number) values ('TM1_DRKQTY_RSPS_CD',	'44',	0,		3037705,		44814721,	710235,		NULL,		NULL) ;

UPDATE m
SET observation_concept_id = 0
FROM #observation_mapping09 m
LEFT JOIN @NHISNSC_database.CONCEPT c
  ON c.concept_id = m.observation_concept_id
WHERE ISNULL(m.observation_concept_id, 0) <> 0
  AND (
...
select		CONVERT(BIGINT, c.master_seq) * 100
	...
	from (select hchk_year, person_id, ykiho_gubun_cd, meas_type, meas_value
		...
		on v.visit_occurrence_id = c.master_seq
			and v.person_id = c.person_id
	where (a.meas_value != '' and a.meas_type = 'TM1_DRKQTY_RSPS_CD' and a.hchk_year in ('2009', '2010', '2011', '2012', '2013'))
			and c.source_table = 'GJT'
			and TRY_CONVERT(DATE, CONCAT(a.hchk_year, '0101'), 112) IS NOT NULL
OPTION (MAXDOP 2, RECOMPILE);
GO
...
INSERT INTO @NHISNSC_database.OBSERVATION (observation_id, person_id, observation_concept_id, observation_date, observation_datetime, observation_type_concept_id, value_as_number, value_As_string, value_as_concept_id,
	...
	from (select hchk_year, person_id, ykiho_gubun_cd, meas_type, meas_value
		...
		on v.visit_occurrence_id = c.master_seq
			and v.person_id = c.person_id
	where (a.meas_value != '' and a.meas_type = 'DRNK_HABIT_RSPS_CD' and a.hchk_year in ('2009', '2010', '2011', '2012', '2013'))
			and c.source_table = 'GJT'
			and TRY_CONVERT(DATE, CONCAT(a.hchk_year, '0101'), 112) IS NOT NULL
OPTION (MAXDOP 2, RECOMPILE);
GO
...
select			CONVERT(BIGINT, c.master_seq) * 100
				...
				CASE WHEN b.answer is not null and b.value_as_number is not null then b.value_as_number
					else TRY_CONVERT(float, a.jk_value)
				END as value_as_number,
				value_as_string = null,
				b.value_as_concept_id as value_as_concept_id,
				qualifier_source_value = null,
				...
				a.jk_type as observation_source_value,
				observation_source_concept_id = null,
				unit_source_value = null,
				qualifier_source_Value = null
	from (select * from @NHISNSC_database.JK_VERTICAL where jk_type='CTRB_PT_TYPE_CD') a
				JOIN #observation_mapping b 
				on TRY_CONVERT(bigint, a.jk_value) = b.answer
			JOIN @NHISNSC_database.SEQ_MASTER c
				on a.person_id = c.person_id
